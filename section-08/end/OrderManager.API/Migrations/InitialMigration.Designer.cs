...
namespace OrderManager.API.Migrations
{
    ...
    [Migration("20250121093918_InitialMigration")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("OrderManager.API.Entities.Order", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            OrderDate = new DateTime(2025, 2, 21, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            OrderTotal = 2200.00m,
                        ...
                        new
                        {
                            ...
                            OrderDate = new DateTime(2025, 2, 19, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            OrderTotal = 1240.00m,
                            Title = "Tech Gear"
                        },
                        new
                        {
                            ...
                            OrderDate = new DateTime(2025, 2, 18, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            OrderTotal = 1020.00m,
                            Title = "Entertainment Bundle"
                        });
                });

            modelBuilder.Entity("OrderManager.API.Entities.OrderLine", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("OrderManager.API.Entities.Product", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("OrderManager.API.Entities.Vendor", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("OrderManager.API.Entities.OrderLine", b =>
                {
                    b.HasOne("OrderManager.API.Entities.Order", "Order")
                        .WithMany("OrderLines")
                        .HasForeignKey("OrderId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("OrderManager.API.Entities.Product", "Product")
                        .WithMany("OrderLines")
            ...
            modelBuilder.Entity("ProductVendor", b =>
                {
                    b.HasOne("OrderManager.API.Entities.Product", null)
                        .WithMany()
                        .HasForeignKey("ProductsId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("OrderManager.API.Entities.Vendor", null)
                        .WithMany()
